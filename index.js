...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array, key){
  let newArray = [];
...
// console.log(lowerCaseNames(zooAnimals, 'animal_name'));
  ...
  */
//  function USApop(array, item){ 
//   const newZoo = [];
//  array.reduce(function(accumulator, item) {
//  newZoo.push(accumulator + item['population']);
//   return (newZoo / array.length).toFixed(2);
//  }, 0);
//    return newZoo;
//  }
...
let newZoo = zooAnimals.reduce(function(acc, item) {
...
surfaceArea(length, width, height){
  return 2 * (this.length = this.length * this.width + this.length * this.height + this.width * this.height);
}
